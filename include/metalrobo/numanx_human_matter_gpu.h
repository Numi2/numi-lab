...
#define MR_NUMANX_HUMAN_MATTER_PUBLICATION_FENCE_ABI_VERSION_V2 2u
#define MR_NUMANX_HUMAN_MATTER_PUBLICATION_FENCE_BYTES 128u
#define MR_NUMANX_HUMAN_MATTER_EXACT_TOKEN_VERSION 2u
#define MR_NUMANX_HUMAN_MATTER_EXACT_TOKEN_FINGERPRINT_DOMAIN 0x4e584154u
#define MR_NUMANX_HUMAN_MATTER_EXACT_CLOCK_DOMAIN 2u
#define MR_NUMANX_HUMAN_MATTER_EXACT_CLOCK_QUANTUM_NANOSECONDS 1u

// Trusted dispatch-family discriminator. The accepted token remains exactly
// 64 bytes in both families, so consumers must never infer its clock family
// from the token payload alone. The same high bit is carried independently by
// the physical-owner, proposal, and apply dispatches.
#define MR_NUMANX_HUMAN_MATTER_EXACT_TOKEN_FAMILY (1u << 31u)
...
#define MR_NUMANX_HUMAN_MATTER_DISPATCH_KNOWN_FLAGS                    \
...
#define MR_NUMANX_HUMAN_MATTER_PROPOSAL_MODE_FLAGS                    \
    (MR_NUMANX_HUMAN_MATTER_PROPOSAL_VALIDATE_BRAIN_WITNESS |         \
     MR_NUMANX_HUMAN_MATTER_PROPOSAL_FORCE_REJECT)
#define MR_NUMANX_HUMAN_MATTER_PROPOSAL_KNOWN_FLAGS                   \
    (MR_NUMANX_HUMAN_MATTER_PROPOSAL_MODE_FLAGS |                     \
     MR_NUMANX_HUMAN_MATTER_EXACT_TOKEN_FAMILY)
...
#define MR_NUMANX_HUMAN_MATTER_APPLY_MODE_FLAGS                       \
    (MR_NUMANX_HUMAN_MATTER_APPLY_VALIDATE_BRAIN_ACK |                \
     MR_NUMANX_HUMAN_MATTER_APPLY_FORCE_REJECT)
#define MR_NUMANX_HUMAN_MATTER_APPLY_KNOWN_FLAGS                      \
    (MR_NUMANX_HUMAN_MATTER_APPLY_MODE_FLAGS |                        \
     MR_NUMANX_HUMAN_MATTER_EXACT_TOKEN_FAMILY)
