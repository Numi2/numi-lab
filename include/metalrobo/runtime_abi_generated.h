...
#define MR_RUNTIME_ABI_VERSION 25u
...
enum MRTaskSignalSensorBuffer : mr_u32 {
    MR_TASK_SIGNAL_SENSOR_DISPATCH = 0u,
    MR_TASK_SIGNAL_SENSOR_TASK_PROGRAM = 1u,
    MR_TASK_SIGNAL_SENSOR_TASK_ARENA = 2u,
    MR_TASK_SIGNAL_SENSOR_SENSOR_PROGRAM = 3u,
    MR_TASK_SIGNAL_SENSOR_SENSOR_OUTPUTS = 4u,
    MR_TASK_SIGNAL_SENSOR_SENSOR_METADATA = 5u,
    MR_TASK_SIGNAL_SENSOR_BODY_STATES = 6u,
    MR_TASK_SIGNAL_SENSOR_BUFFER_COUNT = 7u,
};
...
static_assert(MR_TASK_SIGNAL_SENSOR_BUFFER_COUNT <= 31u);
