...
def read_policy_rollout_pack(
    ...
    *,
    ...
    float_tables = (
        ...
        bootstrap_values,
        transitions["reward"],
        transitions["metric_0"],
        transitions["metric_1"],
        transitions["metric_2"],
        transitions["reward_channel_0"],
        transitions["reward_channel_1"],
        transitions["reward_channel_2"],
        transitions["reward_channel_3"],
        transitions["reward_channel_4"],
        transitions["reward_channel_5"],
        transitions["reward_channel_6"],
        transitions["reward_channel_7"],
        transitions["timeout_bootstrap_value"],
        transitions["episode_metric"],
    )
