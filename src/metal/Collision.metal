...
// Canonical pair-parallel manifold and ConstraintIR compiler. Every
// invocation owns one immutable compiled-pair slot, so scheduling order
// cannot affect cache matching or output order.
