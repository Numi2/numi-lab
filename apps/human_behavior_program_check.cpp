...
int main(){try{
    HumanBehaviorProgramSource s;s.bodyCount=3;s.nq=9;s.nv=8;s.task=0;s.timestepNanoseconds=kNumiHumanBehaviorTimestepNanoseconds;
    ...
    HumanBehaviorCompileBinding b;b.bodyCount=3;b.nq=9;b.nv=8;b.timestepNanoseconds=kNumiHumanBehaviorTimestepNanoseconds;
    ...
    {auto x=s;x.nv++;deny(x,b);}{auto x=s;x.timestepNanoseconds=25000;deny(x,b);}
    ...
    {auto x=s;auto y=b;x.timestepNanoseconds=y.timestepNanoseconds=kNumiHumanBehaviorTimestepNanoseconds;require(compileHumanBehaviorProgram(x,y,cooked,error),error.c_str());}
