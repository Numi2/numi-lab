...
// contract.  The package/state pair is generated by --prepared-state-fixture-ns
// with the same immutable source payloads supplied here; no legacy microsecond
// field is allowed to participate in admission.
