...
| `mechanics.g1_source_exact_presets` | **implemented** | `mechanics.actuation` | `metalrobo_g1_model_probe` | `b7f03fb` at 2026-07-31T22:17:00+02:00 (`evidence/baselines/2026-07-31-b7f03fb.json`) | Distinct fingerprinted URDF, companion-MJCF, and RL Lab actuator contracts; no silent 25/35/50 N m mixing. |
| `runtime.swift_metal_session` | **qualified** | `integration.native_simulation` | `metalrobo_simulation` | `b7f03fb` at 2026-07-31T22:17:00+02:00 (`evidence/baselines/2026-07-31-b7f03fb.json`) | Swift schedules bounded native submissions; Metal owns persistent simulator state and transactions. |
| `learning.swift_mlx_ppo` | **implemented** | `integration.native_simulation` | `metalrobo_train` | `b7f03fb` at 2026-07-31T22:17:00+02:00 (`evidence/baselines/2026-07-31-b7f03fb.json`) | In-process Swift/MLX learner. Python PPO and learner-worker runtimes are removed. |
| `tasks.compiled_native_runtime` | **qualified** | `task.program` | `metalrobo_task_program_check` | `b7f03fb` at 2026-07-31T22:17:00+02:00 (`evidence/baselines/2026-07-31-b7f03fb.json`) | Fixed- and floating-base tasks share compiled semantic bindings, native joint/contact observations, reward, termination, reset, curriculum, and randomization. |
| `tasks.generic_typed_operators` | **experimental** | `task.program` | `metalrobo_task_program_check` | `b7f03fb` at 2026-07-31T22:17:00+02:00 (`evidence/baselines/2026-07-31-b7f03fb.json`) | Root capability is explicit and fixed-base execution is qualified, but body/site/goal operators and three complete task families are not yet qualified. |
| `sensors.native_tactile` | **qualified** | `sensors.tactile` | `metalrobo_tactile_check` | `b7f03fb` at 2026-07-31T22:17:00+02:00 (`evidence/baselines/2026-07-31-b7f03fb.json`) | Native deformation, contact evidence, wrench summaries, history, and device-buffer access. |
...
| `policy.dense_native_inference` | **qualified** | `task.program` | `metalrobo_task_program_check` | `b7f03fb` at 2026-07-31T22:17:00+02:00 (`evidence/baselines/2026-07-31-b7f03fb.json`) | Fingerprint-bound normalization, dense actor/critic layers, Gaussian behavior policy, and native inference. |
...
| `presentation.visual_v3` | **qualified** | `presentation.visual_platform` | `metalrobo_visual_platform_probe` | `b7f03fb` at 2026-07-31T22:17:00+02:00 (`evidence/baselines/2026-07-31-b7f03fb.json`) | Authored Visual Presentation V3 path; collision geometry is not a visual fallback. |
